...
object Async {
    ...
    fun onMain(action: suspend () -> Unit): Job {
        return globalScope(Dispatchers.Main).launch {
            action()
        }
    }
    ...
    private val bgContext by lazy { bgDispatcher + globalJobs + exceptionHandler }
    ...
    internal const val STATE_THREAD_NAME = "os-state-thread"
    ...
    internal const val STATE_DIFF_THREAD_NAME = "os-diff-thread"
